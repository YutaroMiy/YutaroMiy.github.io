...
// update the data file, I use "name" to be equal to each type of the 6 types of responses
...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
    	var wordAnswer = readData("wordAnswer");
        var layoutNav = readData("layoutNav");
        var tooMuchSpace = readData("tooMuchSpace");
    ...
    app.post('/mySurvey', urlencodedParser, function(req, res){
        ...
        for (var key in json){
            ...
            if ((key === "colorLayout") && (json[key].length === 2)){
